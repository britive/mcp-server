...
Use the reports tool by first calling the `reports_list` tool to retrieve available reports.
Once you have the report ID, you can run the report using the reports_run tools.
