import datetime
from britive_mcp_tools import mcp, audit_logs_logs
...
:return: Dict of operator keys to operator names."""
    return audit_logs_logs.operators()
...
:raises: ValueError - If from_time is greater than to_time."""
    return audit_logs_logs.query(from_time, to_time, filter_expression, csv)
