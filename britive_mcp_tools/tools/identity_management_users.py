...
@mcp.tool(name="identity_management_users_enable", description="""Checks the status of the specified user identity. If the status is inactive, prompts the user for confirmation to enable it. If confirmed, it performs the enable action. If the identity is already active, it informs the user and suggests disabling it instead.""")
...
@mcp.tool(name="identity_management_users_disable", description="""Checks the status of the specified user identity. If the status is active, prompts the user for confirmation to disable it. If confirmed, it performs the disable action. If the identity is already inactive, it informs the user and suggests enabling it instead.""")
