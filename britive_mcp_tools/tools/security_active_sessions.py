...
@mcp.tool(
    name="security_active_sessions_list_users",
...
@mcp.tool(
    name="security_active_sessions_checkin",
    description="""This Tool will take userId and list of papID i.e. profile application ID and checkin the profile application ID for the user.It will return a message indicating whether the check-in was successful or if there were any issues.This tool should not be used when a user is asking to checkin all their profiles.That should be the my_access_checkout tool.This tool should be used when the user is asking to checkin another users profiles.""",
)
...
@mcp.tool(
    name="security_active_sessions_checkin_all",
    description="""This tool checks in all active sessions for a specific user. It requires the userId to identify the user whose sessions should be checked in. The tool will return a message indicating whether the check-in was successful or if there were any issues.""",
)
